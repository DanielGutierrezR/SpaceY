...
def get_pie_chart(site_dropdown):
    ...
    if site_dropdown == 'ALL':
        ...
        names='class', 
        title= f'Sucess Rate of {site_dropdown}')
        return fig
...
def get_scatter_chart(site_dropdown, slider_range):
    ...
    if site_dropdown == 'ALL':
        fig = px.scatter(df, y = 'class',
        x = 'Payload Mass (kg)',
        color = 'Booster Version Category',
        title = 'Sucess and Payload')
        return fig
    else:
        fig = px.scatter(filtered_df, y = 'class',
        x = 'Payload Mass (kg)',
        color = 'Booster Version Category',
        title = f'Sucess and Payload of {site_dropdown}')
        return fig
